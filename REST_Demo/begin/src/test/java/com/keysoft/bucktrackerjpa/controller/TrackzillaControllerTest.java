...
public class TrackzillaControllerTest {
	...
	public void addApplication() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders
				.post("/tza/application/").accept(MediaType.APPLICATION_JSON)
		...
		// Get the location from response header and assert that it contains the
	...
	public void findApplication() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get(
				"/tza/application/1").accept(MediaType.APPLICATION_JSON);
	...
	public void updateApplication() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders
				.put("/tza/application/").accept(MediaType.APPLICATION_JSON)
				.content(mockApplicationJson)
				.contentType(MediaType.APPLICATION_JSON);
	...
	public void addTicket() throws Exception {
		...
		// Create a put request with an accept header for application\json
		RequestBuilder requestBuilder = MockMvcRequestBuilders
				.post("/tza//ticket").accept(MediaType.APPLICATION_JSON)
				.content(mockTicketJson)
				.contentType(MediaType.APPLICATION_JSON);
